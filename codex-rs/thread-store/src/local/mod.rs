...
impl Clone for LiveRecorderEntry {
    fn clone(&self) -> Self {
        Self {
            recorder: self.recorder.clone(),
            history_mode: self.history_mode,
            // Clones are read-only snapshots used while rotating a segment. The map entry remains
            // the sole owner of the process-wide writer lock for the lifetime of the live writer.
            writer_lock: None,
