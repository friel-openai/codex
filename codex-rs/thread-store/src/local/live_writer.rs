...
fn event_persistence_mode(mode: crate::ThreadEventPersistenceMode) -> EventPersistenceMode {
    match mode {
        crate::ThreadEventPersistenceMode::Limited => EventPersistenceMode::Limited,
        crate::ThreadEventPersistenceMode::Extended => EventPersistenceMode::Extended,
    }
}
