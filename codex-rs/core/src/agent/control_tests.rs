...
async fn spawn_agent_full_history_fork_uses_compact_reference_and_materializes_parent_items() {
    ...
    let list_all_tools = parent_mcp_runtime.manager().list_all_tools_future();
...
"#,
    ...
    let list_all_tools = mcp_connection_manager.list_all_tools_future();
    let required_startup_failures =
